      ...
      <div className="border w-[93rem] h-[15rem] ">
        <div className="border grid grid-cols-3">
          ...
          <div className="border py-10">
            <h2 className="text-hitam-400  font-extrabold font-poppins py-2 ">
              Nama Produks
            </h2>
            <p className="text-hitam  font-extrabold font-poppins mb-6">
              Alamat : Alamat : JL. Kyai Mojo, New York Selatan
            </p>
            <h2 className="text-hitam-400  font-extrabold font-poppins ">
              Harga : Rp. 50.000
            </h2>
      ...
      <div className="border  mt-20">
        <div className="grid grid-cols-2">
          <div className="border w-[40rem] h-[33rem] bg-bgdasar">
            <p className="text-center  font-poppins font-extrabold text-3xl text-white mt-5">
              Canceled
            </p>
